...
| 0x0002 | ASTC LDR 5x4 | ASTC LDR 5x4 压缩 |
| 0x0003 | ASTC LDR 5x5 | ASTC LDR 5x5 压缩 |
| 0x0004 | ASTC LDR 6x5 | ASTC LDR 6x5 压缩 |
| 0x0005 | ASTC LDR 6x6 | ASTC LDR 6x6 压缩 |
| 0x0006 | ASTC LDR 8x5 | ASTC LDR 8x5 压缩 |
| 0x0007 | ASTC LDR 8x6 | ASTC LDR 8x6 压缩 |
| 0x0008 | ASTC LDR 8x8 | ASTC LDR 8x8 压缩 |
| 0x0009 | ASTC LDR 10x5 | ASTC LDR 10x5 压缩 |
| 0x000A | ASTC LDR 10x6 | ASTC LDR 10x6 压缩 |
| 0x000B | ASTC LDR 10x8 | ASTC LDR 10x8 压缩 |
| 0x000C | ASTC LDR 10x10 | ASTC LDR 10x10 压缩 |
| 0x000D | ASTC LDR 12x10 | ASTC LDR 12x10 压缩 |
| 0x000E | ASTC LDR 12x12 | ASTC LDR 12x12 压缩 |
...
| ASTC 4×4 | 有损压缩 | 支持 | 3:1 | 是 | 高质量要求的动画帧，细节丰富的UI元素 |
| ASTC 5×4 | 有损压缩 | 支持 | 3.75:1 | 是 | 质量与压缩率平衡的UI元素 |
| ASTC 5×5 | 有损压缩 | 支持 | 4.75:1 | 是 | 中等质量要求的动画帧 |
| ASTC 6×5 | 有损压缩 | 支持 | 5.7:1 | 是 | 质量与压缩率平衡的动画场景 |
| ASTC 6×6 | 有损压缩 | 支持 | 6.7:1 | 是 | 大多数动画场景（推荐） |
| ASTC 8×5 | 有损压缩 | 支持 | 7.5:1 | 是 | 一般动画背景 |
| ASTC 8×6 | 有损压缩 | 支持 | 8.7:1 | 是 | 一般动画背景 |
| ASTC 8×8 | 有损压缩 | 支持 | 12:1 | 是 | 背景等对细节要求不高的内容 |
| ASTC 10×5 | 有损压缩 | 支持 | 9.6:1 | 是 | 次要背景元素 |
| ASTC 10×6 | 有损压缩 | 支持 | 11.2:1 | 是 | 次要背景元素 |
| ASTC 10×8 | 有损压缩 | 支持 | 14.4:1 | 是 | 远距离背景或模糊效果 |
| ASTC 10×10 | 有损压缩 | 支持 | 19.2:1 | 是 | 远距离背景或模糊效果 |
| ASTC 12×10 | 有损压缩 | 支持 | 20:1 | 是 | 非常远的背景或装饰性元素 |
| ASTC 12×12 | 有损压缩 | 支持 | 25.6:1 | 是 | 极简风格背景或纹理 |
